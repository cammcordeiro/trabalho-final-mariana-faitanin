...
A floração dessas espécie ocorre entre os meses de fevereiro e maio, enquanto que a maturação dos frutos ocorrem entre agosto e novembro. (https://www.arvores.brasil.nom.br/new/brauna/index.htm
...
Não encontrados nenhuma cooredenada inválida.
```{r}
